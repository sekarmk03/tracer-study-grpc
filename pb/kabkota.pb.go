...
var file_kabkota_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x61, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x32, 0x65, 0x0a, 0x0e, 0x4b, 0x61, 0x62,
...
var file_kabkota_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
...
var file_kabkota_proto_depIdxs = []int32{
	2, // 0: tracer_study_grpc.KabKota.created_at:type_name -> google.protobuf.Timestamp
	2, // 1: tracer_study_grpc.KabKota.updated_at:type_name -> google.protobuf.Timestamp
	2, // 2: tracer_study_grpc.KabKota.deleted_at:type_name -> google.protobuf.Timestamp
	0, // 3: tracer_study_grpc.GetAllKabKotaResponse.data:type_name -> tracer_study_grpc.KabKota
	3, // 4: tracer_study_grpc.KabKotaService.GetAllKabKota:input_type -> google.protobuf.Empty
	1, // 5: tracer_study_grpc.KabKotaService.GetAllKabKota:output_type -> tracer_study_grpc.GetAllKabKotaResponse
