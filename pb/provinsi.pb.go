...
var file_provinsi_proto_rawDesc = []byte{
	...
	0x6e, 0x73, 0x69, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x32, 0x68, 0x0a, 0x0f, 0x50, 0x72, 0x6f,
	0x76, 0x69, 0x6e, 0x73, 0x69, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x55, 0x0a, 0x0e,
	0x47, 0x65, 0x74, 0x41, 0x6c, 0x6c, 0x50, 0x72, 0x6f, 0x76, 0x69, 0x6e, 0x73, 0x69, 0x12, 0x16,
	0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66,
...
var file_provinsi_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
...
var file_provinsi_proto_depIdxs = []int32{
	2, // 0: tracer_study_grpc.Provinsi.created_at:type_name -> google.protobuf.Timestamp
	2, // 1: tracer_study_grpc.Provinsi.updated_at:type_name -> google.protobuf.Timestamp
	2, // 2: tracer_study_grpc.Provinsi.deleted_at:type_name -> google.protobuf.Timestamp
	0, // 3: tracer_study_grpc.GetAllProvinsiResponse.data:type_name -> tracer_study_grpc.Provinsi
	3, // 4: tracer_study_grpc.ProvinsiService.GetAllProvinsi:input_type -> google.protobuf.Empty
	1, // 5: tracer_study_grpc.ProvinsiService.GetAllProvinsi:output_type -> tracer_study_grpc.GetAllProvinsiResponse
