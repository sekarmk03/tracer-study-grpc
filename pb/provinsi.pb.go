...
type EmptyProvinsiRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *EmptyProvinsiRequest) Reset() {
	*x = EmptyProvinsiRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *EmptyProvinsiRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*EmptyProvinsiRequest) ProtoMessage() {}

func (x *EmptyProvinsiRequest) ProtoReflect() protoreflect.Message {
	mi := &file_provinsi_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use EmptyProvinsiRequest.ProtoReflect.Descriptor instead.
func (*EmptyProvinsiRequest) Descriptor() ([]byte, []int) {
...
var file_provinsi_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x22, 0xfc, 0x01, 0x0a, 0x08, 0x50, 0x72, 0x6f, 0x76, 0x69, 0x6e, 0x73,
	0x69, 0x12, 0x15, 0x0a, 0x06, 0x69, 0x64, 0x5f, 0x77, 0x69, 0x6c, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x05, 0x69, 0x64, 0x57, 0x69, 0x6c, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x61,
	0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x61, 0x12, 0x14, 0x0a, 0x05,
	0x75, 0x6d, 0x70, 0x31, 0x32, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x75, 0x6d, 0x70,
	0x31, 0x32, 0x12, 0x39, 0x0a, 0x0a, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x64, 0x5f, 0x61, 0x74,
	...
	0x64, 0x41, 0x74, 0x22, 0x16, 0x0a, 0x14, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x50, 0x72, 0x6f, 0x76,
	0x69, 0x6e, 0x73, 0x69, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0x77, 0x0a, 0x16, 0x47,
	0x65, 0x74, 0x41, 0x6c, 0x6c, 0x50, 0x72, 0x6f, 0x76, 0x69, 0x6e, 0x73, 0x69, 0x52, 0x65, 0x73,
	...
	,
...
var file_provinsi_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_provinsi_proto_goTypes = []interface{}{
	(*Provinsi)(nil),               // 0: tracer_study_grpc.Provinsi
	(*EmptyProvinsiRequest)(nil),   // 1: tracer_study_grpc.EmptyProvinsiRequest
	(*GetAllProvinsiResponse)(nil), // 2: tracer_study_grpc.GetAllProvinsiResponse
	(*timestamppb.Timestamp)(nil),  // 3: google.protobuf.Timestamp
}
var file_provinsi_proto_depIdxs = []int32{
	3, // 0: tracer_study_grpc.Provinsi.created_at:type_name -> google.protobuf.Timestamp
	3, // 1: tracer_study_grpc.Provinsi.updated_at:type_name -> google.protobuf.Timestamp
	3, // 2: tracer_study_grpc.Provinsi.deleted_at:type_name -> google.protobuf.Timestamp
	0, // 3: tracer_study_grpc.GetAllProvinsiResponse.data:type_name -> tracer_study_grpc.Provinsi
	1, // 4: tracer_study_grpc.ProvinsiService.GetAllProvinsi:input_type -> tracer_study_grpc.EmptyProvinsiRequest
	2, // 5: tracer_study_grpc.ProvinsiService.GetAllProvinsi:output_type -> tracer_study_grpc.GetAllProvinsiResponse
...
func file_provinsi_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_provinsi_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*EmptyProvinsiRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
