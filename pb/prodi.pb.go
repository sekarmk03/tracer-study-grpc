...
var file_prodi_proto_rawDesc = []byte{
	...
	0x73, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x32, 0xb6, 0x01, 0x0a, 0x0c, 0x50, 0x72, 0x6f, 0x64,
...
var file_prodi_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
...
var file_prodi_proto_depIdxs = []int32{
	4,  // 0: tracer_study_grpc.Prodi.created_at:type_name -> google.protobuf.Timestamp
	4,  // 1: tracer_study_grpc.Prodi.updated_at:type_name -> google.protobuf.Timestamp
	4,  // 2: tracer_study_grpc.Prodi.deleted_at:type_name -> google.protobuf.Timestamp
	0,  // 3: tracer_study_grpc.GetAllProdiResponse.data:type_name -> tracer_study_grpc.Prodi
	4,  // 4: tracer_study_grpc.Fakultas.created_at:type_name -> google.protobuf.Timestamp
	4,  // 5: tracer_study_grpc.Fakultas.updated_at:type_name -> google.protobuf.Timestamp
	4,  // 6: tracer_study_grpc.Fakultas.deleted_at:type_name -> google.protobuf.Timestamp
	2,  // 7: tracer_study_grpc.GetAllFakultasResponse.data:type_name -> tracer_study_grpc.Fakultas
	5,  // 8: tracer_study_grpc.ProdiService.GetAllProdi:input_type -> google.protobuf.Empty
	5,  // 9: tracer_study_grpc.ProdiService.GetAllFakultas:input_type -> google.protobuf.Empty
	1,  // 10: tracer_study_grpc.ProdiService.GetAllProdi:output_type -> tracer_study_grpc.GetAllProdiResponse
	3,  // 11: tracer_study_grpc.ProdiService.GetAllFakultas:output_type -> tracer_study_grpc.GetAllFakultasResponse
